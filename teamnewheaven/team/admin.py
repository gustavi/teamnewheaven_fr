...
class MemberAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ('Avatar', {
            'description': 'Mettre si possible la même largeur et la même long'
                           'ueur. Il est conseillé de mettre une image entre 2'
                           '00*200px et 800*800px',
            'fields': ('avatar',)
        }),
        ('Links', {
        ...
        ('Description and bio', {
            'description': 'Mettre seulement quelques mots présentant le rôle '
                           'dans « Description » (exemple: « Architecte »), la'
                           ' biographie est là pour le reste.',
